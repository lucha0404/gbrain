...
const put_page: Operation = {
  ...
  handler: async (ctx, p) => {
    ...
    // Skip embedding when Vertex AI is not configured. Without a project the
    // client would still attempt the call and burn the full retry budget
    // (~2 minutes total) before failing. Detect early.
